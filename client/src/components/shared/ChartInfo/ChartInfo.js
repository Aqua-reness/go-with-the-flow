      ...
      <div className="chart-info-content">
        <Card>
            <Card.Body>
              ...
              <Card.Text>{ chartDescription }</Card.Text>
          </Card.Body>
        </Card>
      </div>
    );
